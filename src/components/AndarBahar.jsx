...
const AndarBahar = () => {
  ...
  const [showWinAnimation, setShowWinAnimation] = useState(false); // New
  ...
  const placeBet = (option) => {
    ...
    setTimeout(() => {
      ...
      if (option === winner) {
        ...
        setShowWinAnimation(true); // Show animation
        setTimeout(() => setShowWinAnimation(false), 3000); // Hide animation
      } else {
